...
def presentate(defined_list):
    ...
    for i in range(0, len(defined_list)):
        ...
        try:
            slide2 = add_slide_img(prs, title_slide_layimg, "images/" + photo_loader.search_and_download_images(defined_list[i]["Topic"], 1)[0])
        except:
            slide2 = add_slide_img(prs, title_slide_layimg, "images/" + photo_loader.search_and_download_images(defined_list[i]["Topic"], 2)[1])
        photo_loader.empty_images_folder()
